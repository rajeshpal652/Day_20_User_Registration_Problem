...
public class TestUserRegistration {
    ...
    public TestUserRegistration(String email, boolean expected_Result) {
        super();
        this.email = email;
    ...
    @Test
    public void givenAEmailPattern_WhenMatched_ShouldReturn_True_or_False() {
        Assert.assertEquals(expected_Result, userRegistration.emailCheck(email));
    }
}
